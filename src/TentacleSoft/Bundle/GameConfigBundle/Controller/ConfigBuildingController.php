...
use TentacleSoft\Bundle\GameConfigBundle\Entity\ConfigBuilding;
use TentacleSoft\Bundle\GameConfigBundle\Form\ConfigBuildingType;
...
class ConfigBuildingController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GameConfigBundle:ConfigBuilding')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GameConfigBundle:ConfigBuilding')->find($id);
     ...
     * @Method("POST")
     * @Template("GameConfigBundle:ConfigBuilding:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("GameConfigBundle:ConfigBuilding:edit.html.twig")
     */
