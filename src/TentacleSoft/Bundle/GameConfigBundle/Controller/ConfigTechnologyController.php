...
namespace TentacleSoft\Bundle\GameConfigBundle\Controller;
...
use TentacleSoft\Bundle\GameConfigBundle\Entity\ConfigTechnology;
use TentacleSoft\Bundle\GameConfigBundle\Form\ConfigTechnologyType;
...
class ConfigTechnologyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GameConfigBundle:ConfigTechnology')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GameConfigBundle:ConfigTechnology')->find($id);
     ...
     * @Method("POST")
     * @Template("GameConfigBundle:ConfigTechnology:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("GameConfigBundle:ConfigTechnology:edit.html.twig")
     */
