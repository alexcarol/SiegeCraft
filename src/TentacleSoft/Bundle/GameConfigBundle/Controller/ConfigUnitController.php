...
class ConfigUnitController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GameConfigBundle:ConfigUnit')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GameConfigBundle:ConfigUnit')->find($id);
     ...
     * @Method("POST")
     * @Template("GameConfigBundle:ConfigUnit:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("GameConfigBundle:ConfigUnit:edit.html.twig")
     */
